...
urlpatterns = [
    ...
    path("history/submission/<str:id>/", views.submission_details_view, name="submission_details"),
    path(
        "history/submission/<str:sub_id>/analysis/<int:img_id>/",
        views.analysis_view,
        name="analysis",
    ),
    path("history_admin/", views.HistoryAdminView.as_view(), name="history_admin"),
    path("history_admin/submission/<str:id>/", views.submission_admin_view, name="submission_admin"),
    path(
        "history_admin/submission/<str:sub_id>/analysis/<int:img_id>/",
